...
public class JsonExtendetsClassAdapter<T> implements JsonSerializer<T>, JsonDeserializer<T> {
    ...
    public T deserialize(JsonElement json, Type type, JsonDeserializationContext context) throws JsonParseException {
        ...
        JsonPrimitive primitiv = (JsonPrimitive) jsonObject.get(CLASSNAME);
        String className = primitiv.getAsString();
        try {
